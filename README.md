...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nodeenv-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5328&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nodeenv-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nodeenv` can be installed with:

```
conda install nodeenv
```

It is possible to list all of the versions of `nodeenv` available on your platform with:
